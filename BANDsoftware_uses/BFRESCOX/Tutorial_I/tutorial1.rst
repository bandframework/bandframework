...
First, we will verify that ``frescox`` works as expected when called from Python. Additional notes on obtaining and building ``frescox`` can be found in the `README </BANDsoftware_uses/BFRESCOX/README.md>`_.
