...
The BAND Framework's currently maintained software tools can be found in [software/](/software/). 
...
- rose ([v1.1.7](https://github.com/bandframework/rose/tree/main )): A reduced-order scattering emulator.
