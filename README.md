...
- SmoothEmulator ([v1.0-beta.1](https://github.com/bandframework/SmoothEmulator/releases/tag/v1.0-beta.1)): A simplex sampler, emulator trainer, and MCMC explorer that employs a smooth emulator.
