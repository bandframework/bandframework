...
More about the goals and structure of the BAND project can be found in D.R. Phillips et al., "[Get on the BAND Wagon: a Bayesian framework for quantifying model uncertainties in nuclear dynamics"]([https://doi.org/10.1088/1361-6471/abf1df](https://arxiv.org/abs/2012.07704)), J. Phys. G **48** (2021) 7, 072001.
