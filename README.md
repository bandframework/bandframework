...
- jitr ([v2.0](https://github.com/beykyle/jitr/releases/tag/v2.0 )): A Python package containing a Lagrange mesh R-matrix solver for parametric reaction model calibration
