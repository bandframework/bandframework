...
- Smooth Emulator ([v1.0.0-beta](https://github.com/bandframework/SmoothEmulator/releases/tag/v1.0-beta.1)): A simplex sampler, emulator trainer, and MCMC explorer that employs a smooth emulator.
