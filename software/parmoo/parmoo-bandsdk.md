...
|**R9.**| Use a limited and well-defined name space (e.g., symbol, macro, library, include) |Full| The [MOOP class](https://parmoo.readthedocs.io/en/latest/about.html) is the fundamental data structure in ParMOO. ParMOO modules are located in the `parmoo` directory.|
