...
The version of pybmc adopted for the BAND Framework is v0.4.1, found [here](https://github.com/ascsn/pybmc/tree/v0.4.1).
...
For a simple example of the package in action, check the Usage section of the documentation [here](https://ascsn.github.io/pybmc/usage/#1-load-and-prepare-data). For an interactive notebook of the same procedure, you can load [this file](https://github.com/ascsn/pybmc/blob/v0.4.1/pybmc/test.ipynb) locally or in any Jupyter environment.
