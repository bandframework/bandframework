...
\vspace*{-8pt}{\tt
\begin{Verbatim}[commandchars=\\\{\}]
..% \textcolor{darkred}{cp \textit{SMOOTH_HOME}/software/pybind_stuff/smoothy_emulate.py $\{MY_ANALYSIS\}/}
...
\vspace*{-8pt}{\tt
\begin{Verbatim}[commandchars=\\\{\}]
$\{MY_ANALYSIS\}% \textcolor{darkred}{python3 \textit{SMOOTH_HOME}/software/pybind_stuff/smoothy_emulate.py}
