...
The class definition from the header file, {\tt \$\{SMOOTH\_HOME\}/software/include/msu\_smoothutils/log.h} is
\vspace*{-8pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
class CLog\{
  public:
...
The program prints out a number between 0 and 1. One can reset the seed via {\tt randy->reset(int seed)}. The class defined in the header file, {\tt \$\{SMOOTH\_HOME\}/software/include/msu\_smoothutils/randy.h}, is 
\vspace*{-8pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
class Crandy\{
public:
  Crandy(int iseed);
