...
{\tt \$\{MY\_LOCAL\}} & \parbox{5in}{Should be a subdirectory of {\tt \$\{GITHOME\_BAND\_SMOOTH\}/}\\
...
Then, the user should have established a personalized project directory by duplicating the {\tt \$\{GITHOME\_BAND\_SMOOTH\}/templates/myproject/} directory onto their computer. The User should have also compiled the main libraries
{\tt
\begin{verbatim}
