...
\vspace*{-8pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
$\{MY_ANALYSIS\}% \textcolor{darkred}{\textit{SMOOTH_HOME}/bin/smoothy_trainingpoint_optimizer}
...
\vspace*{-8pt}{\tt \begin{Verbatim}[commandchars=\\\{\}]
   $\{MY_ANALYSIS\}% \textcolor{darkred}{\textit{SMOOTH_HOME}/bin/smoothy_fakefullmodel}
   NPars=6, NObs=10
