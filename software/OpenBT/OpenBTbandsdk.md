...
|**R10.**| Give best effort at portability to key architectures. |Full| The Meson build allows installation on Linux and macOS and is tested regularly with Open MPI and MPICH.  Actions test the Python package with all supported versions of Python. |
