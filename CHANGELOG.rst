...
- updated BAND-compatible parMOO to `v0.4.1 <https://github.com/parmoo/parmoo/releases/tag/v0.4.0>`_, which now includes JIT compilation and automatic differentiation capabilities via `jax`
